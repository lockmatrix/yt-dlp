...
class BilibiliSpaceVideoIE(BilibiliSpaceBaseIE):
    ...
    def _real_extract(self, url):
        ...
        request_page_sleep_time = self.get_param('request_page_sleep_time', default_sleep_time)
        self.to_screen(f'request_page_sleep_time is set to {request_page_sleep_time}, ' +
